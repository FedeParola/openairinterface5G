...
exec gdb \
	...
	--eval-command="target remote $GDBSRV" \
	--eval-command="break uk_sched_thread_add" \
	--eval-command="continue" \
	--eval-command="continue" \
	--eval-command="clear uk_sched_thread_add" \
	--eval-command="$( gdb-add-symbols "./nr-softmodem" "1009b7f000" )" \
	~/src/app-elfloader/workdir/build/elfloader_qemu-x86_64.dbg
